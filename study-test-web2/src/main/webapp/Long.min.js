 ...
 */
    ...
    (function (s) {
        ...
        b.fromNumber = function (a, c) {
            c = !!c;
            return isNaN(a) || !isFinite(a) ? b.ZERO : !c && a <= -v ? b.MIN_SIGNED_VALUE : !c && a + 1 >= v ? b.MAX_SIGNED_VALUE : c &&
            a >= w ? b.MAX_UNSIGNED_VALUE : 0 > a ? b.fromNumber(-a, c).negate() : new b(a % l | 0, a / l | 0, c)
        };
        ...
        b.prototype.equals = function (a) {
            ...
            a.unsigned && this.high >>> 31 != a.high >>> 31 ? r : this.high == a.high && this.low == a.low
        };
        ...
        b.prototype.add = function (a) {
            ...
            d = d + (c + f) & 65535;
            return b.fromBits((a &
                65535) << 16 | m & 65535, d << 16 | e & 65535, this.unsigned)
        };
        ...
        b.prototype.multiply = function (a) {
            ...
            if (this.lessThan(x) &&
                a.lessThan(x))return b.fromNumber(this.toNumber() * a.toNumber(), this.unsigned);
        ...
        b.prototype.div = function (a) {
            ...
            if (a.equals(b.MIN_SIGNED_VALUE))return this.unsigned ? b.UZERO : b.ZERO;
            if (this.isNegative())return a.isNegative() ? this.negate().div(a.negate()) :
        ...
        b.prototype.shiftLeft = function (a) {
            return 0 === (a &= 63) ? this : 32 > a ? b.fromBits(this.low << a, this.high << a | this.low >>> 32 - a, this.unsigned) : b.fromBits(0,
